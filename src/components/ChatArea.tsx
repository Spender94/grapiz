  ...
  return (
    <div className="w-full md:w-2/5 h-[400px] md:h-auto relative rounded-lg overflow-hidden">
      ...
      <div className="relative z-20 p-4 flex flex-col h-full">
        <div className="text-[#AE670C] font-['Verdana'] text-base mb-4 leading-tight">
        ...
        <div className="flex-1 overflow-y-auto mb-4 space-y-2">
          {messages.map((msg) => (
            <div 
              key={msg.id} 
              className="text-[#AE670C] font-['Verdana'] text-base leading-relaxed"
            >
        ...
        <form onSubmit={handleSubmit} className="mt-auto">
          <input
            ...
            className="w-full p-3 rounded-lg bg-[#AC5800] text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 font-['Verdana']"
          />
        </form>
      </div>
    </div>
